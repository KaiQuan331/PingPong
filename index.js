// // var mode; //setermine whether game started or not
// // function setup() {
// //     mode = 0
// // }
...
// create collision detection - if it collides just console.log('collide')
// ballmovement - when ball  collides move accordingly
// create pc paddle
...
//     ctx.fillStyle = 'white'
//     ctx.fillRect(10, playerY, 10, 50)
//     ctx.fillStyle = 'blue'
//     ctx.fillRect(canvas.width -20, 200, 10, 50)
//     ctx.fillStyle = 'red'
//     ctx.fillRect(ballX--, ballY, 10, 10)
// }
// function ballMovement(){
//     // check the direction  of  the ball
//     // based on the direction of the ball when it collides change the x, y of the ball
//     // how to calculate angle of deflection based on angle of incidence
//     ctx.arc(ballX, ballY, 0, Math.PI*2)
...
// window.onmousemove = (e) => {playerY = e.clientY}
// animation()